classdef LAllianceAgent < handle
    ...
    properties
        ...
        %tau toward each task,[t11 .. tj ... t1M;
        %                      ti1 .. tij ... tiM;
        %                      tn1 .. tnj ... tnM]
        tauId = 1;
        ti = 1;
        
        %motivation toward each task,[m11 .. mj ... m1M; ... ]
        motivationId = 2;
        mi = 2;
        
        %impatience toward each task,[pi1 .. pij ... piM(p); ... ]
        impatienceId = 3;
        pi = 3;
        
        % Aquiescence Variables:
        
        %aquiescence maximum toward each task, [ai1 .. aij ... aiM; ...]
        aquiescenceId = 4;
        ai = 4;
        
        %time currently on each task, [s11 .. sij ... s1M; ...]
        psiId = 5;
        si = 5;
        
        %maximum allwoed time on each task, [d11 .. dij ... d1M;...]
        deltaId = 6;
        di = 6;
        
        %is robot assigned to a task , [k11 .. kij ... k1M;...]
        taskAssignmentId = 7;
        ji = 7;

        %The status of each task, percieved by each agent, [u11 .. uij ... u1M;...]
        taskStatus = 8;
        ui = 8;
        
        %all the data above stored in a [n,m,6] array.
        data = [];
